<template>
  <div class="metrics-page">
    ...
    <div class="additional-charts-row">
      ...
      <!-- Report table popup -->
    <div v-if="showReportPopup" class="popup-overlay" @click="showReportPopup = false">
      <div class="popup-content" @click.stop>
        <ReportTable :reportData="reportData" />
        <button class="close-button" @click="showReportPopup = false">Close</button>
      </div>
    </div>
...
const generateReport = async () => {
  ...
  showReportPopup.value = true; // Show the popup
};
...
.metrics-page {
  ...
  align-items: start;
  min-width: 1800px; /* Set a minimum width */
  padding: 10px;
